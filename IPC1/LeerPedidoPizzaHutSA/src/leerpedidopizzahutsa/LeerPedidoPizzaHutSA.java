...
public class LeerPedidoPizzaHutSA extends javax.swing.JDialog {

    public LeerPedidoPizzaHutSA(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(leerpedidopizzahutsa.LeerPedidoPizzaHutSAApp.class).getContext().getResourceMap(LeerPedidoPizzaHutSA.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(leerpedidopizzahutsa.LeerPedidoPizzaHutSAApp.class).getContext().getActionMap(LeerPedidoPizzaHutSA.class, this);
